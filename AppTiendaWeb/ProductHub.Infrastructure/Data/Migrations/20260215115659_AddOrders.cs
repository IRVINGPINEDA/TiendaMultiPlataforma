        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClienteTelefono = table.Column<string>(type: "TEXT", maxLength: 40, nullable: true),
                    DireccionEntrega = table.Column<string>(type: "TEXT", maxLength: 250, nullable: false),
                    Notas = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    Estado = table.Column<string>(type: "TEXT", maxLength: 30, nullable: false, defaultValue: "Pendiente"),
                    Canal = table.Column<string>(type: "TEXT", maxLength: 30, nullable: false, defaultValue: "Web"),
